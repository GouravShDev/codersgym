...
class CodingExperiencePage extends StatelessWidget implements AutoRouteWrapper {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CustomizeCodingExperienceBloc,
      ...
      buildWhen: (prev, next) =>
          prev.configurationLoaded != next.configurationLoaded ||
          prev.editorThemeId != next.editorThemeId ||
          prev.darkEditorBackground != next.darkEditorBackground,
      builder: (context, state) {
        ...
        final currentThemeId =
            state.editorThemeId ?? AppCodeEditorTheme.defaultThemeId;
        return Scaffold(
          backgroundColor: !(state?.darkEditorBackground ?? true)
            ...
            builder: (context, state) {
              return AnimatedPadding(
                padding: EdgeInsets.only(
                  bottom: (state.hideKeyboard)
                      ? 0
                      : (state.isCustomizing ? 280 : 120),
                ),
            ...
            builder: (context, state) {
              return SingleChildScrollView(
                child: AppCodeEditorField(
                  ...
                  keyboardType:
                      (state.hideKeyboard) ? TextInputType.none : null,
