...
class AppCoinRewardAnimationWidget extends HookWidget {
  final int? coinCount;
  final CoinRewardType type;

  const AppCoinRewardAnimationWidget._({
    this.coinCount,
    required this.type,
  });

  factory AppCoinRewardAnimationWidget.dailyCheckin() {
    return const AppCoinRewardAnimationWidget._(
      coinCount: 1,
      type: CoinRewardType.dailyCheckin,
    );
  }

  factory AppCoinRewardAnimationWidget.dailyChallenge({
  ...
  factory AppCoinRewardAnimationWidget.monthlyCheckin({
    required VoidCallback onComplete,
  }) {
    return const AppCoinRewardAnimationWidget._(
      coinCount: 30,
